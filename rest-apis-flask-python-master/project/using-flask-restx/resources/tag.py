...
nested_item = api.inherit(
    "NestedItem", item_id, {"name": fields.String(), "price": fields.Float(),},
)

nested_tag = api.model("NestedTag", {"id": fields.Integer(), "name": fields.String(),},)

tag_outputs = api.inherit(
    "Tag", nested_tag, {"items": fields.List(fields.Nested(nested_item)),},
)
